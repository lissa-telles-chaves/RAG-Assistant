...
with st.sidebar:
    ...
    # TO DO: API Key input
    # Make sure the user can hide their input with type="password"
    ...
    db_path = st.text_input("Database Path",
                            ...
                            help = "Path to yout DuckDB vector database")
    ...
    st.markdown("""
    ### About change it to fit yours!
    This RAG assistant answers questions about ESG using:
    Books:
    - ESG: The Insights You Need from Harvard Business Review
    - The Coming Boom in Regenerative Captalism
    ...
    - ESG and emerging technologies: A cluster-based literature review analysis
    - The use of ESG scores in academic literature: a systematic literature review          
    Websites Articles by:
    - Investopedia
...
with st.expander("💡 Example Questions"):
    examples = [
        ...
        "What is the difference between Benefit Corporation and B-Corp?",
        "Give me the 3 most common ESG metrics.",
        "What are the main takeaways of Chapter 4 'ESG: HOW CSOs BUILD SUCCESSFUL SUSTAINABILITY AND ESG STRATEGIES'?", 
        "What is the impact of New York's Statewide GHG Disclosure for Large Emitters mean for executives and investors?"
    ]
