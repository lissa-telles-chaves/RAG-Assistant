...
#decorations are functions that take in other functions and make things specific to that function
    ...
    @staticmethod
    @st.cache_resource
        #^using the cache_resource before the rest of the funciton makes sure we don't re-download it time and time again
